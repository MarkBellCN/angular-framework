...
@Component({
  selector: 'app-sys-log-save',
  templateUrl: './sys-log-save.component.html',
  styleUrls: ['./sys-log-save.component.css'],
  providers:[DataTableService]
})

export class SysLogSaveComponent implements OnInit {
  public nodes: any[]=[];
  formModel: FormGroup;
  title: string = "";
  data: any = {};
