...
@Component({
  selector: 'ui-sidebar',
  template: `
    <div #containe [@panelState]="visible ? 'visible' : 'hidden'" [ngStyle]="style" [class.show]="visible" [class]="styleClass">
...
export class UiSidebar implements AfterViewInit, AfterViewChecked, OnDestroy {
