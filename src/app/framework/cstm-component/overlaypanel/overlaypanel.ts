...
@Component({
  selector: 'ui-overlayPanel',
  template: `
        <div [ngClass]="'ui-overlaypanel'" [ngStyle]="style" [class]="styleClass"
            [style.display]="visible ? 'block' : 'none'" (click)="onPanelClick($event)" [@panelState]="visible ? 'visible' : 'hidden'">
            <div class="ui-overlaypanel-content">
                <ng-content></ng-content>
            </div>
            <a href="#" *ngIf="showCloseIcon" class="ui-overlaypanel-close" (click)="onCloseClick($event)">
...
export class UiOverlayPanel implements AfterViewInit,AfterViewChecked,OnDestroy {
...
@NgModule({
  ...
  exports: [UiOverlayPanel],
  declarations: [UiOverlayPanel]
})
export class UiOverlayPanelModule { }
