      ...
      <div class="ant-message-notice-content">
        <div *ngIf="!nzMessage.html" class="ant-message-custom-content" [ngClass]="'ant-message-' + nzMessage.type">
          <ng-container [ngSwitch]="nzMessage.type">
            <i *ngSwitchCase="'success'" class="anticon anticon-check-circle-o"></i>
            <i *ngSwitchCase="'info'" class="anticon anticon-info-circle-o"></i>
            <i *ngSwitchCase="'warning'" class="anticon anticon-exclamation-circle-o"></i>
            <i *ngSwitchCase="'error'" class="anticon anticon-cross-circle-o"></i>
            <i *ngSwitchCase="'loading'" class="anticon anticon-spin anticon-loading-o"></i>
          </ng-container>
